from saf.linear.config import Config as BaseConfig


class Config(BaseConfig):
    """Configuration for the linear simulations with Fickett's model."""
    ...
    def q(self, value):
        ...
        if value_cast >= 0.0:
            ...
            raise ValueError('Parameter `q` must be nonnegative.')
    ...
    def theta(self, value):
        ...
        if value_cast >= 0.0:
            ...
            raise ValueError('Parameter `theta` must be nonnegative.')
    ...
    def ic_type(self):
        ...
        znd type is when the initial condition is a scaled ZND solution.
