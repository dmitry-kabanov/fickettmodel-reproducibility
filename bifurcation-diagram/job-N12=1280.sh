#!/bin/bash -l
#SBATCH --partition=72hours    # Default queue with time limit 1 day.
#SBATCH --ntasks=251           # Number of MPI tasks.
#SBATCH --hint=nomultithread   # Avoid hyperthreading.
#SBATCH --time=00-72:00        # Time limit in DD-HH:MM format.
#SBATCH --job-name=bif1280
